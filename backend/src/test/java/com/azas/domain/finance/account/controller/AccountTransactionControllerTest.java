...
class AccountTransactionControllerTest {
    ...
    @Test
    void returnsAccountTransactionsWithListFieldsOnly()
            throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.transactions[0].counterparty_name")
                        .value("KB국민 5678"))
                ...
                .andExpect(jsonPath("$.transactions[0].memo")
                        .doesNotExist())
                .andExpect(jsonPath("$.transactions[0].deposit_account")
                        .doesNotExist())
                .andExpect(jsonPath("$.transactions[0].withdrawal_account")
                        .doesNotExist())
    ...
    @Test
    void returnsEmptyTransactionArray() throws Exception {
        when(accessTokenMemberResolver.resolveMemberId(
                "Bearer access-token"
        )).thenReturn(MEMBER_ID);
        when(accountTransactionService.getTransactions(
    ...
    @Test
    void returnsExpectedAccountTransactionErrors() throws Exception {
