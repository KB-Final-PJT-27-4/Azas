...
public final class ChildAccountListItemResponse {
    ...
    @ApiModelProperty(value = "복호화한 전체 계좌번호", required = true, example = "123-4567-8901")
    ...
    @ApiModelProperty(value = "마지막 동기화 기준 잔액", required = true, example = "1250000.00")
    ...
    @ApiModelProperty(value = "계좌 상태", required = true, allowableValues = "ACTIVE", example = "ACTIVE")
