...
(
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT ='로그인 가능한 회원';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='회원 휴대폰 SMS 인증 요청';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='회원 소셜 계정';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='Refresh Token 저장소';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='부모가 등록하는 자녀 프로필';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='부모와 자녀 연결';
...
(
    ...
    curation_reason              VARCHAR(1000)   NULL COMMENT '검수된 정적 큐레이션 사유',
    ...
    interest_rate_reference      VARCHAR(200)    NULL COMMENT '금리 산정 기준 안내',
    ...
    join_termination_method      VARCHAR(1000)   NULL COMMENT '가입·해지 방법',
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='KB 금융상품';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='관심 금융상품';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='Mock 금융계좌';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='금융 목표 달성 체크포인트';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='계좌 잔액 스냅샷';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='금융 계좌별 자녀 타임캡슐 보관함';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='타임캡슐 기록';
...
(
    ...
    member_id                  BIGINT UNSIGNED NOT NULL COMMENT '회원 ID',
    notification_category      VARCHAR(50)     NOT NULL COMMENT 'SAVINGS, TIME_CAPSULE, ALLOWANCE, PREGNANCY, USAGE_LIMIT, MISSION',
    enabled                    TINYINT(1)      NOT NULL DEFAULT 1 COMMENT '인앱 및 푸시 알림 통합 수신 여부',
    created_at                 DATETIME(6)     NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '생성일',
    updated_at                 DATETIME(6)     NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '수정일',

    PRIMARY KEY (notification_preference_id),
    UNIQUE KEY uk_notification_preference_member_category (member_id, notification_category),
...
(
    ...
    child_id              BIGINT UNSIGNED NULL COMMENT '관련 자녀 ID',
    notification_category VARCHAR(50)     NOT NULL COMMENT '사용자 설정 기준 알림 카테고리',
    notification_type     VARCHAR(50)     NOT NULL COMMENT '구체적인 알림 이벤트 유형',
    ...
    metadata_json         JSON            NULL COMMENT '금액, 임신 주차, 캐릭터 등 추가 정보',
    deduplication_key     VARCHAR(200)    NULL COMMENT '동일 이벤트 중복 알림 방지 키',
    is_read               TINYINT(1)      NOT NULL DEFAULT 0 COMMENT '읽음 여부',
    created_at            DATETIME(6)     NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '생성일',

    PRIMARY KEY (notification_id),
    UNIQUE KEY uk_notification_deduplication_key (deduplication_key),
    KEY idx_notification_member_id (member_id, notification_id),
    KEY idx_notification_member_read_id (member_id, is_read, notification_id),
    KEY idx_notification_member_category_id (member_id, notification_category, notification_id),
