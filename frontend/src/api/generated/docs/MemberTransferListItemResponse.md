# MemberTransferListItemResponse
...
**requested_by_member_id** | **number** |  | [optional] [default to undefined]
...
```typescript
import { MemberTransferListItemResponse } from './api';

const instance: MemberTransferListItemResponse = {
    amount,
    child_id,
    completed_at,
    destination_account,
