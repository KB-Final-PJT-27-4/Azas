...
**account_number** | **string** | 복호화한 전체 계좌번호 | [default to undefined]
...
```typescript
import { ParentAccountListItemResponse } from './api';

const instance: ParentAccountListItemResponse = {
    account_id,
    account_name,
    account_number,
