...
**child** | [**ParentInviteChildResponse**](ParentInviteChildResponse.md) |  | [default to undefined]
**expires_in** | **number** | Access Token 만료까지 남은 시간(초) | [default to undefined]
**invitation** | [**ParentInviteInvitationResponse**](ParentInviteInvitationResponse.md) |  | [default to undefined]
...
```typescript
import { ParentInviteOAuthResponse } from './api';

const instance: ParentInviteOAuthResponse = {
    access_token,
    child,
    expires_in,
    invitation,
