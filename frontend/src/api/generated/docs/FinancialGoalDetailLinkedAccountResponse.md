# FinancialGoalDetailLinkedAccountResponse
...
```typescript
import { FinancialGoalDetailLinkedAccountResponse } from './api';

const instance: FinancialGoalDetailLinkedAccountResponse = {
    account_id,
    account_name,
    account_number,
    balance,
