...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/child/transfer',
    name: 'ChildTransfer',
    component: () => import('@/views/child/ChildTransferView.vue'),
    meta: {
      requiresAuth: true,
      roles: ['CHILD'],
      hideBottomNavigation: true,
  ...
  {
    path: '/child/allowance-requests',
    name: 'ChildAllowanceRequests',
    component: () => import('@/views/child/ChildAllowanceRequestsView.vue'),
    meta: {
      requiresAuth: true,
      roles: ['CHILD'],
      hideBottomNavigation: true,
      headerTitle: '용돈 요청 내역',
      showHeaderBack: true,
    },
  },
  {
    path: '/child/missions',
    name: 'ChildMissions',
    component: () => import('@/views/child/ChildMissionsView.vue'),
    meta: {
      requiresAuth: true,
      roles: ['CHILD'],
      hideBottomNavigation: true,
  ...
  },
  {
    path: '/child/quiz',
    name: 'ChildQuiz',
    component: () => import('@/views/child/ChildQuizView.vue'),
    meta: {
      requiresAuth: true,
      roles: ['CHILD'],
      hideBottomNavigation: true,
